...
title('SARSA with Different Step Sizes on Cliffworld, Epsilon = 0.4','fontweight','bold','fontsize',12);
...
xlabel('Number of Episodes','fontweight','bold','fontsize',12)
ylabel('Cumulative Reward','fontweight','bold','fontsize',12)
title('Q-Learning with Different Step Sizes on Cliffworld, Epsilon = 0.4','fontweight','bold','fontsize',12);
